...
###ChEMBL test <75
# test_dir = '/cvhci/temp/zihanchen/data/ChEMBL/chembl/test/'
# sample_submission_dir = '/cvhci/temp/zihanchen/data/ChEMBL/chembl/test.csv'
...
#python /cvhci/temp/zihanchen/data/model/src/create_input_files.py --train_file True
## Multi-dataset：
# lg dataset + 1M PubChem
"""train"""
data_dir = Path('/cvhci/temp/zihanchen/data/lg_PubChem1M_RDkitclear_noise')
